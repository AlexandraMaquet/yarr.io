...
export class GameComponent implements OnInit {
    ...
    public buildPhaserRenderer() {
        ...
        function create() {
            ...
            //  Text
            var style = { font: "24px Arial", fill: "#435658" };
            stateText = game.add.text(0, 0, style);
            ...
            // Create player
            player.sprite = game.add.sprite(Math.random() * WORLD_SIZE.w / 2 + WORLD_SIZE.w / 2, Math.random() * WORLD_SIZE.h / 2 + WORLD_SIZE.h / 2, 'ship1_1');
            ...
            socket.on('bullets-update', function (server_bullet_array) {
                ...
                for (var i: number = server_bullet_array.length; i < bullet_array.length; i++) {
            ...
            socket.on('player-hit', function (id) {
                if (id == socket.id) {
                    ...
                    if (player.sprite.health < -5) {
                        ...
                        stateText.text = "click to respawn";
        ...
        function GameLoop() {
            ...
            stateText.y = player.sprite.y - 75;
